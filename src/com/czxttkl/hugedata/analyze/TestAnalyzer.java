...
public abstract class TestAnalyzer {
	...
	public TestAnalyzer(String resultDirStr,
			...
			HashMap<String, String> publicMetrics) throws IOException {
	...
	/**
	 * Analyzer will block after append public metrics until all the results
	 * have been pulled from the mobile end.
	 */
	...
	public void setTitle() {
		...
		Element phoneManufacturerTitle = doc
				.getElementById("phoneManufacturerTitle");
		phoneManufacturerTitle
				.text(getStringValue("html.phone.manufacturer.title"));
